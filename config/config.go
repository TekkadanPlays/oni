...
var DatabaseFilePath = "data/oni.db"
...
// WebServerPort is the port for Oni's webserver that is used for this execution of the service.
...
func GetReleaseString() string {
	...
	return fmt.Sprintf("Oni v%s-%s (%s)", versionNumber, buildPlatform, gitCommit)
}
