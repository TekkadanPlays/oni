...
import (
	...
	"github.com/TekkadanPlays/oni/metrics"
	"github.com/TekkadanPlays/oni/utils"
	"github.com/TekkadanPlays/oni/webserver/router"
)
...
var (
	...
	restoreDatabaseFile   = flag.String("restoreDatabase", "", "Restore an Oni database backup")
...
func main() {
	...
	if *restoreDatabaseFile != "" {
		...
		log.Println("Database has been restored.  Restart Oni.")
		log.Exit(0)
	}
